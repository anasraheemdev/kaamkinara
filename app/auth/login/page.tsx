...
import { Wrench, Users, Eye, EyeOff } from "lucide-react"
          ...
          <CardHeader>
            <Tabs value={loginType} onValueChange={setLoginType} className="w-full">
              ...
              <TabsContent value="customer" className="mt-6">
                ...
                <CardDescription>Access your account to book services</CardDescription>
              </TabsContent>
          ...
          <CardContent>
            <form className="space-y-6">
              <div className="space-y-2">
                ...
                <Input id="email" type="text" placeholder="Enter your email or phone number" required />
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href={`/auth/signup?role=${loginType}`} className="text-blue-600 hover:underline">
                  Sign up here
                </Link>
              </p>
            </div>
